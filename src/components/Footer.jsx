            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col lg:flex-row justify-between gap-12 mb-16">
                    ...
                    <div className="flex flex-wrap gap-12 lg:gap-24">
                        ...
                        <div className="flex flex-col space-y-4">
                            ...
                            <p className="text-gray-400 hover:text-[#00D2A8] transition-colors">Vision Training</p>
                            <p className="text-gray-400 hover:text-[#00D2A8] transition-colors">Opening Explorer</p>
                            <p className="text-gray-400 hover:text-[#00D2A8] transition-colors">Daily Challenge</p>
                        </div>

                        {/* Column 2: Learn */}
                        <div className="flex flex-col space-y-4">
                            <h4 className="font-bold text-lg mb-2 text-[#00D2A8]">Learn</h4>
                            <p className="text-gray-400 hover:text-[#00D2A8] transition-colors">Blog</p>
                            <p className="text-gray-400 hover:text-[#00D2A8] transition-colors">Piece Guide</p>
                            <p className="text-gray-400 hover:text-[#00D2A8] transition-colors">Strategy</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col lg:flex-row justify-between items-center gap-8 pt-8 border-t border-gray-800">
                    <div className="w-full lg:w-auto">
                        <p className="text-gray-500">© {new Date().getFullYear()} Chess Warmup - <a href="https://ibrahimsezer.github.io" target="_blank" rel="noopener noreferrer" className="hover:text-[#00D2A8] transition-colors">İbrahim Sezer</a>. All rights reserved.</p>
                    </div>
